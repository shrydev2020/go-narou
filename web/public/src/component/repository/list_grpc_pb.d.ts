...
import * as list_pb from "component/repository/flist_pb";
import * as google_protobuf_timestamp_pb from "google-protobuf/google/protobuf/timestamp_pb";

interface INovelListService
  extends grpc.ServiceDefinition<grpc.UntypedServiceImplementation> {
  get: INovelListService_IGet;
}

interface INovelListService_IGet
  extends grpc.MethodDefinition<list_pb.Req, list_pb.Novels> {
  path: "/NovelList/Get";
  requestStream: false;
